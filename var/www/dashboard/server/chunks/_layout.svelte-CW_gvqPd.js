import { c as create_ssr_component, s as subscribe, a as setContext, v as validate_component, n as noop } from './ssr-C-9IsUTH.js';
import { r as readable } from './index2-DbZx0BBT.js';
import { R as Root, s as showToast, E as ERROR, C as CHANGE_MAIN_COLOR } from './Root-C1R-nd4p.js';
import { G as GetText } from './Text-DvReL212.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const services = readable({
    ...
    "urls": GetServiceURL({ name: "url-shortner" })
  });
  ...
  return `${validate_component(Root, "Toast").$$render($$result, {}, {}, {})} ${`<div class="loading-page" data-svelte-h="svelte-1r1299i"><h1>Loading</h1></div>`}`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-CW_gvqPd.js.map
