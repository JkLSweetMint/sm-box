import { c as create_ssr_component, v as validate_component, a as subscribe, s as setContext, b as add_attribute, d as each, e as escape, n as null_to_empty, f as spread, h as escape_object, i as escape_attribute_value, g as getContext, j as compute_rest_props, k as get_store_value, l as set_store_value, o as onDestroy } from './ssr-DMU0SlpY.js';
import { r as readable, w as writable, d as derived, a as readonly } from './index-D_TN2ZLB.js';
import { c as cn, t as toWritableStores$2, o as omit$2, w as withGet, g as generateIds$1, a as overridable$1, m as makeElement, e as executeCallbacks$2, b as addMeltEventListener$1, k as kbd$2, s as styleToString$3, p as portalAttr, n as noop$1, u as usePortal$1, i as isBrowser$2, d as tick, f as isElement, h as disabledAttr, j as isHTMLElement$2, l as getDirectionalKeys, q as dequal, r as nanoid, v as isFunction$1, x as createElHelpers$1 } from './index2-BrDZvn8A.js';
import { B as Button, G as GHOST, N as NO_RIPPLE, a as NO_ANIMATION, P as PLAIN, C as CIRCLE, e as effect$2, u as useModal, b as useEscapeKeydown$1, c as useFocusTrap, g as getPortalDestination$1, r as removeScroll$1, d as derivedVisible, f as usePopper, n as next, p as prev, l as last$1, s as sleep$2, h as createFocusTrap$1 } from './Button-CvnlLuLc.js';
...
async function handleFocus$1(args) {
  const { prop, defaultEl } = args;
  await Promise.all([sleep$2(1), tick]);
  if (prop === void 0) {
    defaultEl?.focus();
    return;
  }
  ...
  if (typeof returned === "string") {
    ...
    if (!isHTMLElement$2(el))
      return;
    el.focus();
  } else if (isHTMLElement$2(returned)) {
    returned.focus();
  }
}
...
const { name: name$3 } = createElHelpers$1("dialog");
const defaults$4 = {
  preventScroll: true,
...
const { name: name$2 } = createElHelpers$1("popover");
const popoverIdParts = ["trigger", "content"];
function createPopover(args) {
  const withDefaults = { ...defaults$3, ...args };
  const options = toWritableStores$2(omit$2(withDefaults, "open", "ids"));
  ...
  const open = overridable$1(openWritable, withDefaults?.onOpenChange);
  const activeTrigger = withGet.writable(null);
  const ids = toWritableStores$2({ ...generateIds$1(popoverIdParts), ...withDefaults.ids });
  function handleClose() {
    open.set(false);
  }
  ...
  const content = makeElement(name$2("content"), {
    ...
    returned: ([$isVisible, $open, $activeTrigger, $portal, $contentId]) => {
      return {
        hidden: $isVisible && isBrowser$2 ? void 0 : true,
        tabindex: -1,
        style: $isVisible ? void 0 : styleToString$3({ display: "none" }),
        id: $contentId,
    ...
    action: (node) => {
      ...
      const unsubDerived = effect$2([isVisible, activeTrigger, positioning, disableFocusTrap, closeOnOutsideClick, portal], ([$isVisible, $activeTrigger, $positioning, $disableFocusTrap, $closeOnOutsideClick, $portal]) => {
        unsubPopper();
        ...
        tick().then(() => {
          ...
          unsubPopper = usePopper(node, {
            ...
            options: {
              ...
              portal: getPortalDestination$1(node, $portal),
  ...
  const trigger = makeElement(name$2("trigger"), {
    ...
    action: (node) => {
      ...
      const unsub = executeCallbacks$2(addMeltEventListener$1(node, "click", toggleOpen), addMeltEventListener$1(node, "keydown", (e) => {
        if (e.key !== kbd$2.ENTER && e.key !== kbd$2.SPACE)
          return;
        e.preventDefault();
        toggleOpen();
  ...
  const overlay = makeElement(name$2("overlay"), {
    ...
    action: (node) => {
      let unsubDerived = noop$1;
      let unsubPortal = noop$1;
      unsubDerived = effect$2([portal], ([$portal]) => {
        unsubPortal();
        if ($portal === null)
          return;
        const portalDestination = getPortalDestination$1(node, $portal);
        if (portalDestination === null)
          return;
        unsubPortal = usePortal$1(node, portalDestination).destroy;
      });
      return {
        destroy() {
          unsubDerived();
  ...
  const arrow = makeElement(name$2("arrow"), {
    stores: arrowSize,
    returned: ($arrowSize) => ({
      "data-arrow": true,
      style: styleToString$3({
  ...
  effect$2([open, activeTrigger, preventScroll], ([$open, $activeTrigger, $preventScroll]) => {
    if (!isBrowser$2 || !$open)
      return;
    const unsubs = [];
    if ($preventScroll) {
      unsubs.push(removeScroll$1());
    }
    handleFocus$1({ prop: openFocus.get(), defaultEl: $activeTrigger });
    return () => {
  ...
  effect$2(open, ($open) => {
    if (!isBrowser$2 || $open)
      return;
    const triggerEl = document.getElementById(ids.trigger.get());
    handleFocus$1({ prop: closeFocus.get(), defaultEl: triggerEl });
  }, { skipFirstRun: true });
  return {
    ids,
    elements: {
...
const NavigationLink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${data ? (() => {
    ...
    return ` ${data.children ? `<button class="${[
      ...
      "page__navigation__list__link svelte-aelmyg",
      ($toggleMenu ? "full" : "") + " " + (nested ? "nested" : "")
    ].join(" ").trim()}"${add_attribute("href", url, 0)}><div class="icon svelte-aelmyg"><span class="${escape(null_to_empty(data.icon ?? "fa-solid fa-circle"), true) + " svelte-aelmyg"}"></span></div> ${$toggleMenu ? `<span class="text-sm">${escape(data.title)}</span>` : ``} ${nested ? `<span class="indicator svelte-aelmyg"></span>` : ``}</a>`}`;
  })() : ``}`;
});
const css$6 = {
...
const NotificationsBlock = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${spread(
  ...
  )}><div class="notifications-block__header svelte-1rz0x92"><span class="text-xl font-semibold" data-svelte-h="svelte-10sqq72">Notifications</span> <div${spread([escape_object($list), { class: "notifications-block__nav" }], { classes: "svelte-1rz0x92" })}>${each(triggers, (triggerItem) => {
    ...
    )}>${escape(triggerItem.title)} </button>`;
  })}</div></div> <div${spread(
    [
      { tabindex: "-1" },
...
const CustomizerOption = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${escape(null_to_empty("customizer-option" + cn(palette)), true) + " svelte-1nf0f0x"}">   <label tabindex="0" role="radio"${add_attribute("aria-checked", userSelect == value, 0)} class="svelte-1nf0f0x"><span class="customizer-option__body svelte-1nf0f0x">${slots.body ? slots.body({}) : ``}</span></label> ${slots.label ? slots.label({}) : ``} </div>`;
});
...
const css$3 = {
  code: '.drawer-overlay.svelte-hrumbr{position:fixed;inset:0px;z-index:var(--dialog-z-index);background-color:rgb(0 0 0 / 0.5)\n}.drawer-container.svelte-hrumbr{position:fixed;top:0px;z-index:var(--dialog-z-index);display:flex;height:100vh;width:100%;max-width:32rem;flex-direction:column;--tw-bg-opacity:1;background-color:rgb(var(--base1) / var(--tw-bg-opacity));--tw-shadow:0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)\n}.drawer-container.svelte-hrumbr:focus{outline:2px solid transparent;outline-offset:2px\n}.drawer-container.left.svelte-hrumbr{left:0px\n}.drawer-container.left.svelte-hrumbr:where([dir="rtl"], [dir="rtl"] *){right:0px;left:auto\n}.drawer-container.right.svelte-hrumbr{right:0px\n}.drawer-container.right.svelte-hrumbr:where([dir="rtl"], [dir="rtl"] *){left:0px;right:auto\n}.drawer-container__title.svelte-hrumbr{margin-bottom:0px;--tw-bg-opacity:1;background-color:rgb(var(--neutral) / var(--tw-bg-opacity));padding:1.5rem;font-size:1.125rem;line-height:1.75rem;font-weight:600;--tw-text-opacity:1;color:rgb(var(--neutral-fg) / var(--tw-text-opacity))\n}.drawer-container__close.svelte-hrumbr{position:absolute;right:10px;top:26px;display:inline-flex;height:1.5rem;width:1.5rem;-webkit-appearance:none;-moz-appearance:none;appearance:none;align-items:center;justify-content:center;border-radius:9999px;--tw-text-opacity:1;color:rgb(var(--neutral-fg) / var(--tw-text-opacity));transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms\n}.drawer-container__close.svelte-hrumbr:hover{background-color:rgb(var(--error) / 0.2);--tw-text-opacity:1;color:rgb(var(--error) / var(--tw-text-opacity))\n}.drawer-container__close.svelte-hrumbr:focus{--tw-text-opacity:1;color:rgb(var(--error) / var(--tw-text-opacity));outline:2px solid transparent;outline-offset:2px;--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000);--tw-ring-opacity:1;--tw-ring-color:rgb(var(--error) / var(--tw-ring-opacity))\n}.drawer-container__close.svelte-hrumbr:where([dir="rtl"], [dir="rtl"] *){left:10px;right:auto\n}',
  map: '{"version":3,"file":"Drawer.svelte","sources":["Drawer.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { fade, fly } from \\"svelte/transition\\";\\nimport { createDialog, melt } from \\"@melt-ui/svelte\\";\\nimport { cn } from \\"@/lib/helpers\\";\\nexport const Open = () => {\\n  $open = true;\\n};\\nexport const Close = () => {\\n  $open = false;\\n};\\nexport const Toggle = () => {\\n  $open != $open;\\n};\\nconst {\\n  elements: {\\n    overlay,\\n    content,\\n    title,\\n    close,\\n    portalled\\n  },\\n  states: { open }\\n} = createDialog({\\n  forceVisible: true\\n});\\nexport let direction = \\"right\\";\\n<\/script>\\r\\n\\r\\n{#if $open}\\r\\n    <div class=\\"\\" {...$portalled} use:$portalled.action>\\r\\n        <div\\r\\n            {...$overlay} use:$overlay.action\\r\\n            class=\\"drawer-overlay\\"\\r\\n            transition:fade={{ duration: 150 }}\\r\\n        />\\r\\n        <div\\r\\n            {...$content} use:$content.action\\r\\n            class={\\"drawer-container\\" + cn(direction)}\\r\\n            transition:fly={{\\r\\n                x: 350 * (direction == \\"left\\" ? -1 : 1) * (document.documentElement.getAttribute(\\"dir\\") == \\"rtl\\" ? -1 : 1),\\r\\n                duration: 300,\\r\\n                opacity: 1,\\r\\n            }}\\r\\n        >\\r\\n            <button\\r\\n                {...$close} use:$close.action\\r\\n                aria-label=\\"Close\\"\\r\\n                class=\\"drawer-container__close\\"\\r\\n            >\\r\\n                <i class=\\"fa-solid fa-xmark\\"></i>\\r\\n            </button>\\r\\n            <div {...$title} use:$title.action class=\\"drawer-container__title\\">\\r\\n                <slot name=\\"title\\" />\\r\\n            </div>\\r\\n            <section class=\\"p-6 max-h-full overflow-y-auto\\">\\r\\n                <slot />\\r\\n            </section>\\r\\n        </div>\\r\\n    </div>\\r\\n{/if}\\r\\n\\r\\n<style lang=\\"postcss\\">\\r\\n    .drawer-overlay {\\r\\n    position: fixed;\\r\\n    inset: 0px;\\r\\n    z-index: var(--dialog-z-index);\\r\\n    background-color: rgb(0 0 0 / 0.5)\\n}\\r\\n    .drawer-container {\\r\\n    position: fixed;\\r\\n    top: 0px;\\r\\n    z-index: var(--dialog-z-index);\\r\\n    display: flex;\\r\\n    height: 100vh;\\r\\n    width: 100%;\\r\\n    max-width: 32rem;\\r\\n    flex-direction: column;\\r\\n    --tw-bg-opacity: 1;\\r\\n    background-color: rgb(var(--base1) / var(--tw-bg-opacity));\\r\\n    --tw-shadow: 0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);\\r\\n    --tw-shadow-colored: 0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color);\\r\\n    box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)\\n}\\r\\n    .drawer-container:focus {\\r\\n    outline: 2px solid transparent;\\r\\n    outline-offset: 2px\\n}\\r\\n    .drawer-container.left {\\r\\n    left: 0px\\n}\\r\\n    .drawer-container.left:where([dir=\\"rtl\\"], [dir=\\"rtl\\"] *) {\\r\\n    right: 0px;\\r\\n    left: auto\\n}\\r\\n    .drawer-container.right {\\r\\n    right: 0px\\n}\\r\\n    .drawer-container.right:where([dir=\\"rtl\\"], [dir=\\"rtl\\"] *) {\\r\\n    left: 0px;\\r\\n    right: auto\\n}\\r\\n    .drawer-container__title {\\r\\n    margin-bottom: 0px;\\r\\n    --tw-bg-opacity: 1;\\r\\n    background-color: rgb(var(--neutral) / var(--tw-bg-opacity));\\r\\n    padding: 1.5rem;\\r\\n    font-size: 1.125rem;\\r\\n    line-height: 1.75rem;\\r\\n    font-weight: 600;\\r\\n    --tw-text-opacity: 1;\\r\\n    color: rgb(var(--neutral-fg) / var(--tw-text-opacity))\\n}\\r\\n    .drawer-container__close {\\r\\n    position: absolute;\\r\\n    right: 10px;\\r\\n    top: 26px;\\r\\n    display: inline-flex;\\r\\n    height: 1.5rem;\\r\\n    width: 1.5rem;\\r\\n    -webkit-appearance: none;\\r\\n       -moz-appearance: none;\\r\\n            appearance: none;\\r\\n    align-items: center;\\r\\n    justify-content: center;\\r\\n    border-radius: 9999px;\\r\\n    --tw-text-opacity: 1;\\r\\n    color: rgb(var(--neutral-fg) / var(--tw-text-opacity));\\r\\n    transition-property: color, background-color, border-color, text-decoration-color, fill, stroke;\\r\\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\\r\\n    transition-duration: 150ms\\n}\\r\\n    .drawer-container__close:hover {\\r\\n    background-color: rgb(var(--error) / 0.2);\\r\\n    --tw-text-opacity: 1;\\r\\n    color: rgb(var(--error) / var(--tw-text-opacity))\\n}\\r\\n    .drawer-container__close:focus {\\r\\n    --tw-text-opacity: 1;\\r\\n    color: rgb(var(--error) / var(--tw-text-opacity));\\r\\n    outline: 2px solid transparent;\\r\\n    outline-offset: 2px;\\r\\n    --tw-ring-offset-shadow: var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);\\r\\n    --tw-ring-shadow: var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);\\r\\n    box-shadow: var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000);\\r\\n    --tw-ring-opacity: 1;\\r\\n    --tw-ring-color: rgb(var(--error) / var(--tw-ring-opacity))\\n}\\r\\n    .drawer-container__close:where([dir=\\"rtl\\"], [dir=\\"rtl\\"] *) {\\r\\n    left: 10px;\\r\\n    right: auto\\n}\\r\\n</style>"],"names":[],"mappings":"AA6DI,6BAAgB,CAChB,QAAQ,CAAE,KAAK,CACf,KAAK,CAAE,GAAG,CACV,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAC9B,gBAAgB,CAAE,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC;AACtC,CACI,+BAAkB,CAClB,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,GAAG,CACR,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAC9B,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,CAAC,CAClB,gBAAgB,CAAE,IAAI,IAAI,OAAO,CAAC,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,CAAC,CAC1D,WAAW,CAAE,kEAAkE,CAC/E,mBAAmB,CAAE,8EAA8E,CACnG,UAAU,CAAE,IAAI,uBAAuB,CAAC,UAAU,CAAC,CAAC,CAAC,IAAI,gBAAgB,CAAC,UAAU,CAAC,CAAC,CAAC,IAAI,WAAW,CAAC;AAC3G,CACI,+BAAiB,MAAO,CACxB,OAAO,CAAE,GAAG,CAAC,KAAK,CAAC,WAAW,CAC9B,cAAc,CAAE,GAAG;AACvB,CACI,iBAAiB,mBAAM,CACvB,IAAI,CAAE,GAAG;AACb,CACI,iBAAiB,mBAAK,OAAO,CAAC,GAAG,CAAC,KAAK,CAAC,EAAE,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAE,CACzD,KAAK,CAAE,GAAG,CACV,IAAI,CAAE,IAAI;AACd,CACI,iBAAiB,oBAAO,CACxB,KAAK,CAAE,GAAG;AACd,CACI,iBAAiB,oBAAM,OAAO,CAAC,GAAG,CAAC,KAAK,CAAC,EAAE,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAE,CAC1D,IAAI,CAAE,GAAG,CACT,KAAK,CAAE,IAAI;AACf,CACI,sCAAyB,CACzB,aAAa,CAAE,GAAG,CAClB,eAAe,CAAE,CAAC,CAClB,gBAAgB,CAAE,IAAI,IAAI,SAAS,CAAC,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,CAAC,CAC5D,OAAO,CAAE,MAAM,CACf,SAAS,CAAE,QAAQ,CACnB,WAAW,CAAE,OAAO,CACpB,WAAW,CAAE,GAAG,CAChB,iBAAiB,CAAE,CAAC,CACpB,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,CAAC;AAC1D,CACI,sCAAyB,CACzB,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,GAAG,CAAE,IAAI,CACT,OAAO,CAAE,WAAW,CACpB,MAAM,CAAE,MAAM,CACd,KAAK,CAAE,MAAM,CACb,kBAAkB,CAAE,IAAI,CACrB,eAAe,CAAE,IAAI,CAChB,UAAU,CAAE,IAAI,CACxB,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,aAAa,CAAE,MAAM,CACrB,iBAAiB,CAAE,CAAC,CACpB,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,CAAC,CACtD,mBAAmB,CAAE,KAAK,CAAC,CAAC,gBAAgB,CAAC,CAAC,YAAY,CAAC,CAAC,qBAAqB,CAAC,CAAC,IAAI,CAAC,CAAC,MAAM,CAC/F,0BAA0B,CAAE,aAAa,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CACxD,mBAAmB,CAAE,KAAK;AAC9B,CACI,sCAAwB,MAAO,CAC/B,gBAAgB,CAAE,IAAI,IAAI,OAAO,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACzC,iBAAiB,CAAE,CAAC,CACpB,KAAK,CAAE,IAAI,IAAI,OAAO,CAAC,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,CAAC;AACrD,CACI,sCAAwB,MAAO,CAC/B,iBAAiB,CAAE,CAAC,CACpB,KAAK,CAAE,IAAI,IAAI,OAAO,CAAC,CAAC,CAAC,CAAC,IAAI,iBAAiB,CAAC,CAAC,CACjD,OAAO,CAAE,GAAG,CAAC,KAAK,CAAC,WAAW,CAC9B,cAAc,CAAE,GAAG,CACnB,uBAAuB,CAAE,kFAAkF,CAC3G,gBAAgB,CAAE,uFAAuF,CACzG,UAAU,CAAE,IAAI,uBAAuB,CAAC,CAAC,CAAC,IAAI,gBAAgB,CAAC,CAAC,CAAC,IAAI,WAAW,CAAC,UAAU,CAAC,CAC5F,iBAAiB,CAAE,CAAC,CACpB,eAAe,CAAE;AACrB,CACI,sCAAwB,OAAO,CAAC,GAAG,CAAC,KAAK,CAAC,EAAE,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAE,CAC3D,IAAI,CAAE,IAAI,CACV,KAAK,CAAE,IAAI;AACf"}'
};
const Drawer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_close();
  $$unsubscribe_title();
  return `${$open ? `<div${spread([{ class: "" }, escape_object($portalled)], { classes: "svelte-hrumbr" })}><div${spread([escape_object($overlay), { class: "drawer-overlay" }], { classes: "svelte-hrumbr" })}></div> <div${spread(
    [
    ...
    { classes: "svelte-hrumbr" }
  )}><i class="fa-solid fa-xmark"></i></button> <div${spread([escape_object($title), { class: "drawer-container__title" }], { classes: "svelte-hrumbr" })}>${slots.title ? slots.title({}) : ``}</div> <section class="p-6 max-h-full overflow-y-auto">${slots.default ? slots.default({}) : ``}</section></div></div>` : ``}`;
});
const css$2 = {
...
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Search, "Search").$$render(
      ...
      {
        title: () => {
          return `<span data-svelte-h="svelte-109ivdm">Theme customizer</span> `;
        },
        default: () => {
          return `<div class="flex flex-col divide-y-2 divide-base-200"><div class="flex flex-col py-2" data-svelte-h="svelte-1o0wd23"><span class="font-medium text-lg">Theme</span> <span class="text-neutral-400 text-sm">Choose your suitable theme</span></div> <div class="flex flex-col py-2" data-svelte-h="svelte-13empda"><span class="font-medium text-lg">Sidebar images</span> <span class="text-neutral-400 text-sm">Choose an image of Sidebar</span></div> <div class="flex flex-col py-2"><span class="font-medium text-lg" data-svelte-h="svelte-1csanip">Components</span> <span class="text-neutral-400 text-sm" data-svelte-h="svelte-nfds9a">Choose your suitable component style</span> <div class="flex flex-row flex-wrap gap-3 mt-5" role="radiogroup">${validate_component(CustomizerOption, "CustomizerOption").$$render(
            $$result,
            {
              value: "default",
          ...
          )}</div></div> <div class="flex flex-col py-2"><span class="font-medium text-lg" data-svelte-h="svelte-1gi5fbj">Navbar Type</span> <span class="text-neutral-400 text-sm" data-svelte-h="svelte-1dt1f3i">Choose preferred navbar apperance</span> <div class="flex flex-row flex-wrap gap-3 mt-5" role="radiogroup">${validate_component(CustomizerOption, "CustomizerOption").$$render(
            $$result,
            {
              value: "sticky",
          ...
          )}</div></div> <div class="flex flex-col py-2"><span class="font-medium text-lg" data-svelte-h="svelte-1oynyye">Direction</span> <span class="text-neutral-400 text-sm" data-svelte-h="svelte-84841g">Choose preferred direction</span> <div class="flex flex-row flex-wrap gap-3 mt-5" role="radiogroup">${validate_component(CustomizerOption, "CustomizerOption").$$render(
            $$result,
            {
              value: "ltr",
      ...
      {
        default: () => {
          return `<span class="fa-solid fa-magnifying-glass mr-2"></span> <div class="flex flex-row items-center gap-1">${isApple2 ? `${validate_component(Keyboard, "Keyboard").$$render($$result, { char: "⌘" }, {}, {})}` : `${validate_component(Keyboard, "Keyboard").$$render($$result, { char: "ctrl" }, {}, {})}`}
                        +
                        ${validate_component(Keyboard, "Keyboard").$$render($$result, { char: "f" }, {}, {})}</div>`;
        }
      }
    )} <div class="ml-auto rtl:mr-auto rtl:ml-0 flex items-center flex-wrap">${validate_component(Button, "Button").$$render(
      $$result,
      {
        class: "!p-1 w-10 h-10 !text-neutral-400 active:!text-primary md:!hidden",
        flags: NO_RIPPLE | PLAIN | CIRCLE,
      ...
      default: () => {
        return `<div class="flex flex-col"><div class="flex flex-row items-center justify-between col-span-3 border-b border-base-300 border-dashed py-4 px-5" data-svelte-h="svelte-e5o9k5"><span class="text-xl font-semibold">Shortcuts</span></div> <div class="grid grid-cols-3 p-2">${each(shortcuts, (shortcut, idx) => {
      ...
      default: () => {
        return `${validate_component(NotificationsBlock, "NotificationsBlock").$$render($$result, {}, {}, {})}`;
      }
    })}</div></div></div> <div class="page__content svelte-yqfnma"><div class="absolute top-1/2 -translate-y-1/2 right-0 rtl:left-0 rtl:right-auto">${validate_component(Button, "Button").$$render(
      $$result,
      {
        flags: NO_ANIMATION,
        class: "!w-10 !h-10 !rounded-r-none rtl:!rounded-l-none rtl:!rounded-r-btn hover:*:animate-spin",
    ...
    $$result,
    {
      links: [
        { title: "test", href: "/" },
        {
          title: "test_nested",
          href: "/",
          children: [{ title: "nested_link", href: "/" }]
        }
      ],
      shortcuts: [
        {
...
//# sourceMappingURL=_layout.svelte-D1ZYthc_.js.map
