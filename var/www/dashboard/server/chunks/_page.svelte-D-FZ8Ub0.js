import { c as create_ssr_component, g as getContext, o as onDestroy, e as escape, b as add_attribute, v as validate_component, n as noop, s as subscribe, f as null_to_empty, h as spread, i as escape_object, k as set_store_value, j as escape_attribute_value, d as each, m as get_store_value } from './ssr-C-9IsUTH.js';
import { w as writable, r as readable, d as derived, a as readonly } from './index2-DbZx0BBT.js';
import { c as cn } from './index-VQC3TRid.js';
import { s as showToast, E as ERROR, C as CHANGE_MAIN_COLOR } from './Root-DpK35LNX.js';
import { G as GetText, T as Text } from './Text-DvReL212.js';
import { B as Button, S as SUBMIT, b as SMOKE } from './Button-atP5DRSs.js';
import { a as Card } from './Card-BWlCOFJT.js';
import { m as makeElement, o as omit, e as executeCallbacks, q as addEventListener, b as addMeltEventListener, r as isHTMLInputElement, v as isContentEditable, w as withGet, a as overridable, t as toWritableStores, j as createElHelpers, g as generateIds, x as dequal, y as isObject, z as stripValues, d as disabledAttr, k as kbd, A as isHTMLButtonElement, l as tick, c as isHTMLElement, F as FIRST_LAST_KEYS, B as isElementDisabled, s as styleToString, C as isElement, D as generateId, E as createHiddenInput, i as isBrowser, G as getElementByMeltId, H as isHTMLLabelElement, n as noop$1 } from './create-CrsTuLZT.js';
import { L as LanguageSelect, e as effect, d as derivedVisible, l as last, f as back, i as forward, p as prev, n as next, j as usePopper, g as getPortalDestination, r as removeScroll, k as debounce, w as wrapArray, t as toggle, s as sleep } from './LanguageSelect-DH6Fy-Xq.js';
          ...
          return `<div class="relative">${validate_component(Card, "Card").$$render(
            ...
            {},
            {
              fallback: () => {
                ...
                )}</div></div>` : ``} <div class="absolute bottom-2 right-2">${validate_component(LanguageSelect, "LanguageSelect").$$render($$result, { size: "40px" }, {}, {})}</div>`;
              }
            }
            ...
            {},
            {
              footer: () => {
                ...
                )}</div>` : ``} <div class="absolute bottom-2 left-2">${validate_component(LanguageSelect, "LanguageSelect").$$render($$result, { size: "28px" }, {}, {})}</div> `;
              },
              header: () => {
...
//# sourceMappingURL=_page.svelte-D-FZ8Ub0.js.map
