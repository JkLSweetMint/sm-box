import { n as noop, t as toWritableStores, o as omit, a as overridable, w as withGet, g as generateIds, m as makeElement, i as isBrowser, s as styleToString, p as portalAttr, l as tick, C as isElement$1, e as executeCallbacks, b as addMeltEventListener, k as kbd, u as usePortal, x as dequal, J as isFunction, c as isHTMLElement$1, j as createElHelpers, K as isReadable, q as addEventListener, y as isObject } from './create-DiqL_npW.js';
import { c as create_ssr_component, g as getContext, v as validate_component, h as spread, i as escape_object, b as add_attribute, d as each, s as subscribe, j as escape_attribute_value, e as escape, o as onDestroy } from './ssr-0mLmEaQb.js';
import { d as derived, w as writable, r as readable } from './index2-Cn3cpumX.js';
import { c as cn } from './index-VQC3TRid.js';
import { B as Button, N as NO_RIPPLE, P as PLAIN, C as CIRCLE, a as NO_ANIMATION, G as GHOST } from './Button-CWT_JlAX.js';
    ...
    {},
    {
      trigger: ({ melt: melt2, trigger }) => {
        return `<div${spread([{ slot: "trigger" }, escape_object(trigger)], {})}>${validate_component(Button, "Button").$$render(
          ...
          {
            default: () => {
              return `${`<div class="rounded bg-black/20 animate-pulse duration-500 m-1"${add_attribute("style", `width: ${size2}; height: ${size2};`, 0)}></div>`}`;
            }
          }
        )}</div>`;
      },
...
export { DISABLE_CLOSE_BTN as D, LanguageSelect as L, Popover as P, useEscapeKeydown as a, useFocusTrap as b, createFocusTrap as c, derivedVisible as d, effect as e, back as f, getPortalDestination as g, handleFocus as h, forward as i, usePopper as j, debounce as k, last as l, next as n, prev as p, removeScroll as r, sleep as s, toggle as t, useModal as u, wrapArray as w };
//# sourceMappingURL=LanguageSelect-B50hpBXZ.js.map
