import { c as cn, n as noop, u as usePortal, j as isHTMLElement$1, L as isReadable, w as withGet, e as executeCallbacks, y as addEventListener, B as isObject, q as dequal, k as kbd, v as isFunction, f as isElement$1 } from './index2-BrDZvn8A.js';
import { d as derived, r as readable } from './index-D_TN2ZLB.js';
import { c as create_ssr_component, b as add_attribute, e as escape, n as null_to_empty, o as onDestroy } from './ssr-DMU0SlpY.js';
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<button${add_attribute("type", GetButtonType(flags), 0)} class="${escape(null_to_empty("btn" + cn(flags & NO_ANIMATION ? "no-animation" : "") + cn(palette) + cn(flags & PLAIN ? "plain" : "") + cn(flags & CIRCLE ? "circle" : "") + cn(className)), true) + " svelte-1rj8mt1"}"${add_attribute("style", style, 0)}${add_attribute("this", root, 0)}>${slots.default ? slots.default({}) : ``} </button>`;
});

export { Button as B, CIRCLE as C, GHOST as G, NO_RIPPLE as N, PLAIN as P, SUBMIT as S, NO_ANIMATION as a, useEscapeKeydown as b, useFocusTrap as c, derivedVisible as d, effect as e, usePopper as f, getPortalDestination as g, createFocusTrap as h, SMOKE as i, back as j, forward as k, last as l, debounce as m, next as n, prev as p, removeScroll as r, sleep as s, toggle as t, useModal as u, wrapArray as w };
//# sourceMappingURL=Button-CvnlLuLc.js.map
