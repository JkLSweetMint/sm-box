...
import (
	...
	"os"
	"path"
	"sm-box/pkg/core/components/logger/config"
	"sm-box/pkg/core/env"
	"strings"
)
...
func newLogger(initiator string, conf *config.Config) (log *logger, err error) {
	...
	// zap
	{
		...
		// Terminal
		{
			var (
				...
				configs = []*config.TerminalLogLevel{
