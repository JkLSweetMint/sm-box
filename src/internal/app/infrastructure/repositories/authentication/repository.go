...
import (
	...
	db_models2 "sm-box/internal/app/objects/db_models"
	entities2 "sm-box/internal/app/objects/entities"
...
func (repo *Repository) BasicAuth(ctx context.Context, username, password string) (us *entities2.User, err error) {
	// tracer
	{
