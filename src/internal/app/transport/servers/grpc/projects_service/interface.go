...
const (
	loggerInitiator = "transport-[servers]-[grpc]=projects-service"
)

// Server - описание grpc сервера для сервиса проектов системы.
...
func New(ctx context.Context) (srv Server, err error) {
	...
	// grpc
	{
		...
		pb.RegisterProjectsServiceServer(ref.grpc, ref)
	}
