...
type MiddlewareCors struct {
	...
	AllowOrigins []string `json:"allow_origins" yaml:"AllowOrigins" xml:"AllowOrigins"`
	...
	AllowMethods []string `json:"allow_methods" yaml:"AllowMethods" xml:"AllowMethods"`
	...
	//
	// Необязательно. Значение по умолчанию "".
	AllowHeaders []string `json:"allow_headers" yaml:"AllowHeaders" xml:"AllowHeaders"`
	...
	//
	// Необязательно. Значение по умолчанию "".
	ExposeHeaders []string `json:"expose_headers" yaml:"ExposeHeaders" xml:"ExposeHeaders"`
