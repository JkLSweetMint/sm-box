...
import (
	...
	authentication_repository "sm-box/internal/services/users/infrastructure/repositories/authentication"
...
func (usecase *UseCase) BasicAuth(ctx context.Context, username, password string) (us *entities.User, cErr c_errors.Error) {
	...
	usecase.components.Logger.Info().
		Text("We have started receiving information about the user using the basic authorization mechanism.... ").
