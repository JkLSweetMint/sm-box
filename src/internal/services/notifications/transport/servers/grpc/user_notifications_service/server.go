...
// server - grpc сервер для сервиса управления пользовательскими уведомлениями.
type server struct {
	pb.UserNotificationsServiceServer
...
type controllers struct {
	UserNotifications interface {
		CreateOne(ctx context.Context, constructor *constructors.UserNotification) (notification *models.UserNotificationInfo, cErr c_errors.Grpc)
		Create(ctx context.Context, constructors ...*constructors.UserNotification) (notifications []*models.UserNotificationInfo, cErr c_errors.Grpc)
	}
}
